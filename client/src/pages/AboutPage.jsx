...
export function AboutPage() {
  ...
  return (
    <main
      ref={containerRef}
      className="bg-black min-h-screen selection:bg-gold selection:text-black overflow-hidden relative"
    >
      <Helmet>
        <title>About Kazi Motors | Trusted Auto Experts in Bhiwandi</title>
        <meta
          name="description"
          content="Learn about Nisaar Ahemad Kazi and the expert mechanics behind Kazi Motors. With over 12 years of experience, we provide premium car and motorcycle service, repair, and modification in Bhiwandi/Mumbai."
        />
        <meta
          name="keywords"
          content="about kazi motors, nisaar ahemad kazi, auto garage history bhiwandi, experienced mechanics mumbai, best bike mechanic near me, trusted car repair, motorcycle modification experts"
        />
        <meta
          property="og:title"
          content="About Kazi Motors | Bhiwandi's Premier Auto Garage"
        />
        <meta
          property="og:description"
          content="Discover the legacy of Kazi Motors and our commitment to automotive excellence."
        />
      ...
      <section
        ref={heroRef}
        className="relative h-screen flex flex-col justify-start items-start px-6 pt-16 md:pt-28 overflow-hidden"
      >
        ...
        <div className="relative z-30 text-left max-w-10xl mx-auto md:mx-0 md:pl-12">
          ...
          <p className="hero-subtitle text-zinc-300 font-inter text-lg md:text-xl max-w-2xl tracking-wide text-justify">
            Founded and led by{" "}
            <span className="text-gold font-bold">Nisaar Ahemad Kazi</span>, our
            business is built on trust, experience, and a deep understanding of
            the motorcycle industry. With over{" "}
            <span>12 years of hands on experience</span>,the owner has been
            actively involved in sourcing, supplying, and maintaining high
            quality two wheeler parts. This long journey has helped us
            understand customer needs, ensure product authenticity and deliver
            reliable solutions every time What started as a small initiative has
            grown into a trusted name, driven by passion, expertise, and a
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-center">
            <div className="lg:col-span-2">
              <span className="text-gold font-oswald text-sm tracking-[0.3em] uppercase block mb-4">
                Our History
              </span>
              ...
              <p className="text-zinc-400 font-inter leading-relaxed mb-6 text-lg text-justify">
                What started as a small garage driven by a sheer love for
                engines has evolved into the region's premier destination for
                superbike maintenance. Kazi Motors wasn't built overnight; it
                was forged through years of grease, grit, and an unyielding
                commitment to excellence.
              </p>
              <p className="text-zinc-400 font-inter leading-relaxed text-lg text-justify">
                We believe that every bike tells a story, and our job is to keep
                that story running smooth. Whether it's a vintage classic or a
                modern beast, we treat every machine with the respect it
                deserves, ensuring that when you ride out, you ride with
                confidence.
              </p>
            </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="p-8 border border-zinc-900 bg-zinc-950/50 rounded-lg hover:border-gold/50 transition duration-300 group">
              <h3 className="text-2xl font-oswald text-white uppercase mb-4 group-hover:text-gold transition-colors">
                Precision
              </h3>
              <p className="text-zinc-500 font-inter">
                We don't just fix bikes; we engineer solutions. Every bolt,
                every tune is executed with surgical precision to ensure peak
                performance.
              </p>
            </div>
            {/* Value 2 */}
            <div className="p-8 border border-zinc-900 bg-zinc-950/50 rounded-lg hover:border-gold/50 transition duration-300 group">
              ...
              <p className="text-zinc-500 font-inter">
                Transparency is key. We provide honest diagnostics and genuine
                parts, building a relationship of trust with every rider.
              </p>
            </div>
            {/* Value 3 */}
            <div className="p-8 border border-zinc-900 bg-zinc-950/50 rounded-lg hover:border-gold/50 transition duration-300 group">
              ...
              <p className="text-zinc-500 font-inter">
                With decades of combined experience, our team brings a depth of
                knowledge that stands unrivaled in the industry.
              </p>
            </div>
          </div>
        </div>
      ...
      <section
        ref={awardsRef}
        className="pt-20 pb-32 bg-zinc-950 relative overflow-hidden"
      >
        {/* Background Glow */}
              ...
              <div className="relative z-20 p-8 md:p-12 lg:p-16 grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  <div className="mb-6 inline-flex items-center gap-2 text-gold/80 border border-gold/30 rounded-full px-4 py-1.5 w-fit">
                    ...
                    <span className="text-xs uppercase tracking-widest font-oswald">
                      Highest Honor
                    </span>
                  </div>
                  <h3 className="text-4xl lg:text-5xl font-oswald text-white uppercase font-bold mb-6 leading-none">
                    Excellence{" "}
                    <span className="text-transparent bg-clip-text bg-linear-to-r from-gold to-yellow-700">
                      Award
                    </span>
                  </h3>
                  <p className="text-zinc-400 font-inter text-base lg:text-lg leading-relaxed mb-8">
                    This prestigious accolade recognizes our unwavering
                    commitment to quality. It is a testament to the countless
                    hours spent perfecting every tune and the dedication that
                    goes into every service. A symbol of trust and superior
                    craftsmanship.
                  </p>
            ...
            >
              ...
              <div className="relative z-20 p-8 md:p-12 lg:p-16 grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-1 md:order-2 text-left md:text-right">
                  ...
                  <p className="text-zinc-400 font-inter text-base lg:text-lg leading-relaxed mb-8">
                    Awarded for consistently delivering the highest customer
                    satisfaction and mechanical performance. This award reflects
                    our promise: when we touch a bike, it leaves better than
                    new. The true gold standard of service.
                  </p>
