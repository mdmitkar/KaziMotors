...
export function ContactPage() {
  ...
  return (
    <div className="bg-black min-h-screen text-white font-inter selection:bg-gold selection:text-black">
      <Helmet>
        <title>Contact Kazi Motors | Auto Parts & Repair in Bhiwandi</title>
        <meta
          name="description"
          content="Get in touch with Kazi Motors for inquiries, appointments, and custom modification requests. Reach out to Nisaar Ahemad Kazi for the best auto repair services in Bhiwandi."
        />
        <meta
          name="keywords"
          content="contact kazi motors, auto parts store bhiwandi, car repair appointment, bike service booking mumbai, nisaar ahemad kazi contact, two wheeler garage near me, four wheeler mechanic near me"
        />
        <meta
          property="og:title"
          content="Contact Kazi Motors | Book Your Service Today"
        />
        <meta
          property="og:description"
          content="Schedule an appointment for premium car and bike servicing, denting, painting, or modifications in Bhiwandi."
        />
      ...
      <main className="pt-24 pb-20 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="space-y-10">
            ...
            <div ref={titleRef}>
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-oswald font-bold uppercase tracking-tighter text-white mb-6 leading-none">
                REACH{" "}
                <span className="text-transparent bg-clip-text bg-linear-to-r from-gold to-white/70">
                  KAZI
                </span>
                <br />
            ...
            <div className="space-y-6">
              ...
              <div
                ref={addToInfoRefs}
                className="group bg-[#0a0a0a] border border-white/10 p-6 hover:border-gold/50 transition-all duration-300 rounded-sm relative overflow-hidden"
              >
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-oswald font-bold uppercase mb-1 text-white group-hover:text-gold transition-colors">
                      Call Us
                    </h3>
                    <a
                      href="tel:+918855989211"
              ...
              >
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:kaziautopart@gmail.com"
                      className="text-lg font-bold text-gray-300 hover:text-white transition-colors break-all"
                    >
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">
                      352, Panjrapool, Near Nissan Hotel,
                      <br />
          ...
          <div
            ref={formRef}
            className="bg-[#111] p-8 md:p-12 rounded-sm shadow-2xl border border-white/10 relative overflow-hidden lg:sticky lg:top-32"
          >
            {/* Subtle Gold Glow */}
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-gold text-xs font-bold tracking-[0.2em] uppercase ml-1">
                    Name
                  </label>
                  <input
                    type="text"
              ...
              <button
                type="submit"
                className="w-full bg-gold text-black font-oswald font-bold uppercase py-4 hover:bg-white hover:text-black transition-all duration-300 tracking-[0.2em] text-sm mt-4"
              >
                Send Message
              </button>
            </form>
        ...
        <div
          id="map"
          ref={mapRef}
          className="mt-24 w-full h-[450px] bg-transparent rounded-sm relative border border-white/10 overflow-hidden"
        >
          <iframe
