...
export function CartPage() {
  ...
  const handleWhatsAppCheckout = () => {
    ...
    window.open(
      `https://wa.me/918855989211?text=${encodeURIComponent(rawMessage)}`,
      "_blank",
    );
  };
  ...
  return (
    <div className="bg-black min-h-screen text-white font-oswald flex flex-col">
      <Helmet>
        <title>Your Shopping Cart | Kazi Motors</title>
      ...
      <main className="flex-grow pt-32 pb-20 container mx-auto px-4 md:px-8">
        ...
        {cartItems.length === 0 ? (
          <div className="text-center py-20 bg-[#0a0a0a] rounded-3xl border border-white/5">
            ...
            <h2 className="text-2xl font-bold mb-4 uppercase text-white/40">
              Your cart is empty
            </h2>
            <a
              href="/collection"
              className="inline-block bg-gold text-black px-8 py-3 rounded-xl font-bold uppercase tracking-widest hover:bg-white transition-all"
            >
              Start Shopping
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                  ...
                  >
                    ...
                    <div className="flex-grow min-w-0">
                      <div className="flex justify-between items-start mb-2">
                        <div>
                          <p className="text-gold text-[10px] uppercase tracking-widest mb-1">
                            {item.category}
                          </p>
                          <h3 className="text-xl font-bold uppercase truncate pr-12">
                            {item.title}
                          </h3>
                        </div>
                      </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-[#111] border border-white/10 rounded-2xl p-8 sticky top-32">
                <h3 className="text-2xl font-bold uppercase mb-8 border-b border-white/10 pb-4">
                  Order Summary
                </h3>
                ...
                <p className="text-xs text-center mt-4 text-white/30">
                  Secure Checkout via WhatsApp. <br /> We will confirm your
                  order details instantly.
                </p>
              </div>
            </div>
          </div>
